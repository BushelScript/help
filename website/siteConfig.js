...
const siteConfig = {
  ...
  headerLinks: [
    {doc: 'tutorial/index', label: 'Quick Tutorial'},
    {doc: 'ref/index', label: 'Reference'},
    {doc: 'integration/index', label: 'Integration'},
    {doc: 'internal/index', label: 'Internals'},
  ],
  ...
  */
  ...
  copyright: `Copyright © ${new Date().getFullYear()} Ian Gregory`,
